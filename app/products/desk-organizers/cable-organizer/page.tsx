...
export const metadata = {
  ...
  description:
    'An adjustable under desk cable organizer tray designed to keep wires, power strips, and chargers neatly organized and hidden.',
};

const highlights = [
  'No-drill installation option suitable for desks without damaging surfaces',
  'Adjustable extendable design fits different desk sizes',
  'Reinforced carbon steel construction supports heavier power strips',
  'Raised edges prevent cables and accessories from slipping off',
  'Integrated hooks for hanging headphones or small accessories',
];
        ...
        <section className="mx-auto grid max-w-7xl gap-10 px-6 py-12 md:grid-cols-[1.05fr_0.95fr] md:py-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-neutral-600 md:text-lg">
              A practical under desk cable organizer tray designed to keep power
              strips, wires, and chargers neatly arranged beneath your desk.
              Instead of cables hanging or tangling around the floor, the tray
              helps create a cleaner and safer workspace.
            </p>
          ...
          <div className="grid gap-8 rounded-[2rem] border border-gray-200 bg-white p-8 shadow-sm md:grid-cols-2 md:p-10">
            ...
            <div>
              ...
              <h3 className="mt-2 text-2xl font-semibold tracking-tight md:text-4xl">
                A cleaner and safer way to manage desk cables.
              </h3>

              <p className="mt-4 leading-7 text-neutral-600">
                This under desk cable organizer tray helps keep power strips,
                chargers, routers, and device cables neatly arranged under the
                desk instead of spreading across the floor.
              </p>

              <p className="mt-4 leading-7 text-neutral-600">
                Its adjustable extendable design allows the tray to fit
                different desk widths while the reinforced steel structure
                supports heavier devices like surge protectors or power strips.
              </p>
            ...
            <div className="rounded-[1.75rem] bg-gray-50 p-6">
              ...
              <div className="mt-4 grid gap-4">
                ...
                <div className="rounded-2xl bg-white px-4 py-4 text-sm text-neutral-700 shadow-sm">
                  Reduces cable clutter around desk areas
                </div>

                <div className="rounded-2xl bg-white px-4 py-4 text-sm text-neutral-700 shadow-sm">
                  Helps create cleaner and safer workspaces
                </div>
