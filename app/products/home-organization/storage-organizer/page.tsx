...
const highlights = [
  ...
  'Bottom pulley or wheel design helps move the box more easily',
];
        ...
        <section className="mx-auto grid max-w-7xl gap-10 px-6 py-12 md:grid-cols-[1.05fr_0.95fr] md:py-16">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-5 max-w-xl text-base leading-7 text-neutral-600 md:text-lg">
              Keep household items neatly arranged while saving space at home.
              Its transparent panels make it easier to see what is stored inside,
              while the stackable structure helps keep storage areas cleaner and
              more organized.
            </p>
          ...
          <div className="grid gap-8 rounded-[2rem] border border-gray-200 bg-white p-8 shadow-sm md:grid-cols-2 md:p-10">
            <div>
              ...
              <p className="mt-4 leading-7 text-neutral-600">
                Unlike traditional solid storage boxes, this organizer uses transparent
                panels so the contents are easier to identify without opening every
                container. This helps reduce time spent searching for things and keeps
                storage corners easier to manage.
              </p>
              <p className="mt-4 leading-7 text-neutral-600">
                The side opening design makes access more convenient, while the foldable
                structure helps save space when the organizer is not in use. It works well
                for bedrooms, living rooms, balconies, and general home storage areas.
              </p>
            </div>
          ...
          <div className="rounded-[2rem] bg-emerald-600 px-8 py-10 text-white shadow-xl md:px-10 md:py-12">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-sm leading-6 text-white/75 md:text-base">
                Browse practical tools and organizing ideas designed to make home, workspace,
